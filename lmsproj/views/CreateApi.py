    ...
    def post(self,request):
        ...
        if Serializer.is_valid(raise_exception=True):
            try:
                ...
                StartDate = datetime.datetime.strptime(request.data["startdate"],"%Y-%m-%d %I:%M")
                EndDate =   datetime.datetime.strptime(request.data["enddate"],"%Y-%m-%d %I:%M")
                validated_data = request.data
                ...
                Batch.objects.create(name = validated_data["name"] , details = validated_data["details"],
                                    ...
                                    modulename = validated_data["modulename"],isActive = Active  )
